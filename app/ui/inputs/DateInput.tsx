  ...
  return (
    <span className='relative'>
      <input
        ...
        className='rounded-full bg-slate-200 hover:bg-slate-300 active:bg-slate-300 outline-none text-slate-600 transition text-sm font-semibold h-10 px-3 min-w-auto'
