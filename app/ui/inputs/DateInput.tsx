  ...
  return (
    <span
      className='relative flex items-center justify-center rounded-full cursor-pointer
        bg-slate-200 hover:bg-slate-300 focus-within:bg-slate-300 active:bg-slate-300 active:scale-90 transition pe-3 h-10 min-w-10'
    >
      <input
        type='date'
        name='date'
        ...
        className={clsx(
          'outline-none text-slate-600 ps-3 h-full transition text-sm font-semibold w-[10em] cursor-pointer calendar',
          {'icon-only': iconOnly},
        )}
