...
export default function OrderTypeToggle(props: OrderTypeToggleProps) {
  ...
  const commonButtonClasses =
    'w-10 flex rounded-md transition cursor-pointer text-slate-400 hover:text-slate-500 active:text-slate-500';
    ...
    <fieldset className='flex bg-slate-100 rounded-lg p-1 gap-1'>
      <span
        className={clsx(commonButtonClasses, {
          'bg-slate-300/90 shadow-md text-slate-700 hover:text-slate-700 active:text-slate-700 active:scale-90':
